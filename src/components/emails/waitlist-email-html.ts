        ...
        <tr>
          <td align="center" valign="top" style="padding:20px;margin:0;">
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" bgcolor="#FDC500" style="background-color:#FDC500;border-collapse:collapse;margin:0;padding:0;">
              <tbody>
                <tr>
                  <td bgcolor="#FDC500" style="background-color:#FDC500;padding:48px 40px 40px 40px;margin:0;color:#151515;font-family:Arial,sans-serif;">
                    ...
                    <h1 style="font-size:32px;font-weight:700;margin:0 0 24px 0;line-height:1.3;color:#151515;text-align:center;font-family:Arial,sans-serif;">Thank you for joining the <span style="color:#2E7D32;font-family:Arial,sans-serif;">Shopa</span> waitlist!</h1>

                    <p style="font-size:16px;line-height:1.6;margin:20px 0;color:#151515;font-family:Arial,sans-serif;">Hi ${safeName},</p>

                    <p style="font-size:16px;line-height:1.6;margin:20px 0;color:#151515;font-family:Arial,sans-serif;">This means you'll be amongst <strong style="color:#151515;font-family:Arial,sans-serif;">the first to get major updates</strong> about Shopa, get the opportunity to <strong style="color:#151515;font-family:Arial,sans-serif;">participate</strong> in our usability testing before official launch, see special offers and promotions and <strong style="color:#151515;font-family:Arial,sans-serif;">stand a chance</strong> to win amazing prizes from Shopa!</p>

                    <p style="font-size:16px;line-height:1.6;margin:20px 0;color:#151515;font-family:Arial,sans-serif;"><strong style="color:#151515;font-family:Arial,sans-serif;">Please ensure to follow us</strong> across all social media platforms <strong style="color:#151515;font-family:Arial,sans-serif;">@shopanigeria</strong> to be a part of our growing community and also share to your friends!</p>

                    <p style="font-size:16px;line-height:1.6;margin:20px 0;color:#151515;font-family:Arial,sans-serif;">We can't wait to have you on board with the wonderful project we're building that could potentially change the fortunes of student e-commerce.</p>

                    ${safeMessage ? `<div style="background-color:#f0f8f0;padding:16px;margin:24px 0;font-size:15px;line-height:1.6;color:#151515;border-left:4px solid #2E7D32;font-family:Arial,sans-serif;">${safeMessage}</div>` : ""}

                    <p style="font-size:16px;font-weight:600;margin:32px 0 0 0;color:#151515;font-family:Arial,sans-serif;">Courtesy,<br/>Shopa.</p>
